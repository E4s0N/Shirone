...
- Sensitive to subtle visual glitches (e.g. a brief flash of all categories before the filtered view appears when switching tabs). Considers these worth fixing even when they do not affect functionality, and wants the root cause diagnosed rather than the flash tolerated. Confidence: 0.7
