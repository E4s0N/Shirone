...
export const vi: Translation = {
	...
	[Key.albumsSortBy]: "Sắp xếp theo",
	[Key.albumsSortDate]: "Ngày chụp",
	[Key.albumsSortName]: "Tên tệp",
	[Key.albumsSortSize]: "Kích thước",
	[Key.albumsSortAsc]: "Tăng dần",
	[Key.albumsSortDesc]: "Giảm dần",
	...
	[Key.zoomIn]: "Phóng to",
	[Key.zoomOut]: "Thu nhỏ",
	[Key.resetView]: "Đặt lại chế độ xem",
	[Key.imageLoading]: "Đang tải ảnh…",
	...
	[Key.photoResolution]: "Độ phân giải",
	[Key.photoPixels]: "Điểm ảnh",
	[Key.photoDateTaken]: "Ngày chụp",
	[Key.photoLocation]: "Vị trí chụp",
	[Key.photoAlbum]: "Album",
	[Key.photoCamera]: "Máy ảnh",
	[Key.photoLens]: "Ống kính",
	[Key.photoExposure]: "Phơi sáng",
	[Key.photoFileSize]: "Kích thước tệp",
	[Key.photoColorSpace]: "Không gian màu",
	[Key.photoSoftware]: "Phần mềm",
	[Key.photoCoordinates]: "Tọa độ",
	[Key.photoFocal]: "Tiêu cự",
	[Key.photoAperture]: "Khẩu độ",
	[Key.photoExposureTime]: "Thời gian phơi sáng",
	[Key.photoISO]: "ISO",
	[Key.photoHistogram]: "Biểu đồ tần suất",
	[Key.photoArtist]: "Tác giả",
	[Key.photoFocal35]: "Tiêu cự 35mm",
	[Key.photoMaxAperture]: "Khẩu độ tối đa",
	[Key.photoExposureProgram]: "Chương trình phơi sáng",
	[Key.photoMetering]: "Chế độ đo sáng",
	[Key.photoWhiteBalance]: "Cân bằng trắng",
	[Key.photoFlash]: "Đèn flash",
	[Key.livePhoto]: "Ảnh sống",
	[Key.playLivePhoto]: "Phát ảnh sống",
