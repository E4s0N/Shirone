...
export const ja: Translation = {
	...
	[Key.zoomIn]: "拡大",
	[Key.zoomOut]: "縮小",
	[Key.resetView]: "表示をリセット",
	[Key.imageLoading]: "画像を読み込み中…",
	...
	[Key.photoResolution]: "解像度",
	[Key.photoPixels]: "ピクセル",
	[Key.photoDateTaken]: "撮影日時",
	[Key.photoLocation]: "撮影場所",
	[Key.photoAlbum]: "アルバム",
	[Key.photoCamera]: "カメラ",
	[Key.photoLens]: "レンズ",
	[Key.photoExposure]: "露出",
	[Key.photoFileSize]: "ファイルサイズ",
	[Key.photoColorSpace]: "カラースペース",
	[Key.photoSoftware]: "ソフトウェア",
	[Key.photoCoordinates]: "座標",
	[Key.photoFocal]: "焦点距離",
	[Key.photoAperture]: "絞り",
	[Key.photoExposureTime]: "露出時間",
	[Key.photoISO]: "ISO",
	[Key.photoHistogram]: "ヒストグラム",
	[Key.photoArtist]: "作者",
	[Key.photoFocal35]: "35mm換算焦点距離",
	[Key.photoMaxAperture]: "最大絞り",
	[Key.photoExposureProgram]: "露出プログラム",
	[Key.photoMetering]: "測光方式",
	[Key.photoWhiteBalance]: "ホワイトバランス",
	[Key.photoFlash]: "フラッシュ",
	[Key.livePhoto]: "ライブフォト",
	[Key.playLivePhoto]: "ライブフォトを再生",
