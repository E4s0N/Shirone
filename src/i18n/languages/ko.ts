...
export const ko: Translation = {
	...
	[Key.albumsSortBy]: "정렬",
	[Key.albumsSortDate]: "촬영일",
	[Key.albumsSortName]: "파일명",
	[Key.albumsSortSize]: "파일 크기",
	[Key.albumsSortAsc]: "오름차순",
	[Key.albumsSortDesc]: "내림차순",
	...
	[Key.zoomIn]: "확대",
	[Key.zoomOut]: "축소",
	[Key.resetView]: "보기 초기화",
	[Key.imageLoading]: "이미지 로드 중…",
	...
	[Key.photoResolution]: "해상도",
	[Key.photoPixels]: "픽셀",
	[Key.photoDateTaken]: "촬영 시간",
	[Key.photoLocation]: "촬영 위치",
	[Key.photoAlbum]: "앨범",
	[Key.photoCamera]: "카메라",
	[Key.photoLens]: "렌즈",
	[Key.photoExposure]: "노출",
	[Key.photoFileSize]: "파일 크기",
	[Key.photoColorSpace]: "색 공간",
	[Key.photoSoftware]: "소프트웨어",
	[Key.photoCoordinates]: "좌표",
	[Key.photoFocal]: "초점 거리",
	[Key.photoAperture]: "조리개",
	[Key.photoExposureTime]: "노출 시간",
	[Key.photoISO]: "ISO",
	[Key.photoHistogram]: "히스토그램",
	[Key.photoArtist]: "작가",
	[Key.photoFocal35]: "35mm 환산 초점 거리",
	[Key.photoMaxAperture]: "최대 조리개",
	[Key.photoExposureProgram]: "노출 프로그램",
	[Key.photoMetering]: "측광 방식",
	[Key.photoWhiteBalance]: "화이트 밸런스",
	[Key.photoFlash]: "플래시",
	[Key.livePhoto]: "라이브 포토",
	[Key.playLivePhoto]: "라이브 포토 재생",
