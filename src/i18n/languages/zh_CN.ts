...
export const zh_CN: Translation = {
	...
	[Key.albumsSortBy]: "排序",
	[Key.albumsSortDate]: "拍摄日期",
	[Key.albumsSortName]: "文件名",
	[Key.albumsSortSize]: "文件大小",
	[Key.albumsSortAsc]: "正序",
	[Key.albumsSortDesc]: "逆序",
	...
	[Key.zoomOut]: "缩小",
	[Key.resetView]: "重置视图",
	[Key.imageLoading]: "图片加载中…",
	[Key.imageLoadFailed]: "图片加载失败",
	[Key.allPhotos]: "所有图片",
	[Key.viewerInfo]: "图片信息",
	[Key.viewerZoomHint]: "双击缩放，左右滑动切换",
	[Key.photoBasicInfo]: "基本信息",
	[Key.photoCaptureParams]: "拍摄参数",
	[Key.photoFilename]: "文件名",
	[Key.photoResolution]: "分辨率",
	[Key.photoPixels]: "像素",
	[Key.photoDateTaken]: "拍摄时间",
	[Key.photoLocation]: "拍摄地点",
	[Key.photoAlbum]: "所属相册",
	[Key.photoCamera]: "相机",
	[Key.photoLens]: "镜头",
	[Key.photoExposure]: "曝光参数",
	[Key.photoFileSize]: "文件大小",
	[Key.photoColorSpace]: "色彩空间",
	[Key.photoSoftware]: "软件",
	[Key.photoCoordinates]: "坐标",
	[Key.photoFocal]: "焦距",
	[Key.photoAperture]: "光圈",
	[Key.photoExposureTime]: "曝光时间",
	[Key.photoISO]: "ISO",
	[Key.photoHistogram]: "直方图",
	[Key.photoArtist]: "作者",
	[Key.photoFocal35]: "等效焦距",
	[Key.photoMaxAperture]: "最大光圈",
	[Key.photoExposureProgram]: "曝光程序",
	[Key.photoMetering]: "测光模式",
	[Key.photoWhiteBalance]: "白平衡",
	[Key.photoFlash]: "闪光灯",
	[Key.livePhoto]: "实况照片",
	[Key.playLivePhoto]: "播放实况照片",
